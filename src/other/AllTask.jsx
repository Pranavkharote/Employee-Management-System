...
const AllTask = () => {
    ...
    return (
        <div className='bg-[#1c1c1c] rounded-xl shadow-md shadow-black/10 p-6 mt-6'>
            <h2 className=' text-xl font-bold text-gray-100 mb-6'>Task Overview</h2>
            <div className='bg-red-400 mb-4 py-3 px-6 flex justify-between rounded-lg'>
            ...
            <div className='overflow-auto max-h-[300px]'>
                {userData.map((element) => (
                    <div
                        key={element.id}
                        className='bg-[#1e1e1e] border-2 border-green-800 hover:bg-[#222222] mb-2 py-3 px-6 flex justify-between rounded-lg transition-all duration-200'>
